...
<p><strong>How to open it:</strong> press L for the list (Items, Side quests, History, World, Player and Lore tabs &mdash; the last three switchable off in Options), K to toggle the HUD, and pin from any handbook page via its "Add to Tallybook" button. All keys rebindable under Settings &rarr; Controls.</p>
